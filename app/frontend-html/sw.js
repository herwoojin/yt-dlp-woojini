...
const CACHE = 'ytdlp-shell-v13';
const SHELL = ['/', '/index.html', '/blog-studio.html', '/reference-images.html', '/manifest.webmanifest', '/icon.svg', '/icon-192.png', '/icon-512.png', '/screenshot-narrow.png', '/screenshot-wide.png'];
